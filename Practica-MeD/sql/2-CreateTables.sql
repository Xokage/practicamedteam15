...
CREATE TABLE Reserva (
	id BIGINT NOT NULL AUTO_INCREMENT,
	dataReserva TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
	nomeCliente VARCHAR(20) NOT NULL,
	dniCliente VARCHAR(20) NOT NULL,
	dataEntrada TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
	...
	CONSTRAINT Reserva_idHotel_FK FOREIGN KEY (idHotel) REFERENCES Hotel(id)
	);
